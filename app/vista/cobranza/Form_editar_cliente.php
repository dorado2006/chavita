<script>
    $(function() {
        $('#aptualizar_cliente').click(function() {



            var dataString = $('#form_edit_cliente').serialize();
...
<form id="form_edit_cliente" method="post">
    ...
    <input type="hidden" name="idcliente" value="<?php echo $obj[0]['idcliente']; ?>" />
    <!-- Inicio de Modal de Editar Cliente -->
    <div class="modal fade " id="MyModal_bt1" tabindex="-1" role="dialog" aria-labelledby="myModalLabel2" aria-hidden="true" >
                ...
                <div class="modal-body" >
                    <table border="0" width="100%" id="actualizar_cliente" class="actualizar_cliente table"  style="background: #dff0d8;font-size: 15px;font-family: Times New Roman">
                        ...
                        <tr>
                            ...
                            <td class="filas"><input type="text" name="dni" value="<?php echo $obj[0]['dni']; ?>"  readonly></td>
                            <td class="filas"></td>
                            <td class="filas"></td>
                            <td class="filas"></td>
                            <td class="filas"></td>
...
<!--                        <tr>
                        ...
                        <tr>
                            ...
                            <td width="20%" >
                                <select name="tiposervidor" id="busquedasector">
                                    <option value="sele">Selecciana</option> 
                                    <?php
                        ...
                        <td colspan="6">
                            <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#myModal2" id="aptualizar_cliente" ><span class="glyphicon glyphicon-save"></span>Aceptar</button>
                        </td>
                        </tr>
                    </table>
