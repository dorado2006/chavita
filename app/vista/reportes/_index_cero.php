           ...
           var fecha_i=$('#fecha_i').val();
            ...
            var fechaf=separador_ff[0];
             $("#cuerporeporte").empty().append("<img src='../web/img/progress2.gif' alt=''/>");
                ...
                $.post('../web/index.php', 'controller=reportes&action=get_deuda_cero&fechai='+fechai+'&fechaf='+fechaf, function(data) {
                    console.log(data);
...
<h5>REPORTE DE CLIENTES QUE PAGARON, CON SALDO CERO</h5>
<div id="contreporte">
